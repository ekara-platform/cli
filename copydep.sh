...
mkdir ./vendor/github.com/ekara-platform/engine/component/scm/
...
mkdir ./vendor/github.com/ekara-platform/engine/component/scm/file/
...
mkdir ./vendor/github.com/ekara-platform/engine/component/scm/git/
